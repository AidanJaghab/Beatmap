...
# Try to import BeautifulSoup, fall back to text parsing if not available
try:
    from bs4 import BeautifulSoup
    HAS_BS4 = True
except ImportError:
    print("BeautifulSoup not available, using text-only parsing")
    HAS_BS4 = False
...
def scrape_edmtrain_nyc():
    ...
    try:
        ...
        # Use text-based parsing (works with or without BeautifulSoup)
        if HAS_BS4:
            ...
            # Use Selenium's text extraction directly
